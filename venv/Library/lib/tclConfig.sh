...
# installed.
TCL_PREFIX='C:/JAY TALERA/SEMESTER-7/Book-Recommendation-System/Book-Recommendation-System/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/JAY TALERA/SEMESTER-7/Book-Recommendation-System/Book-Recommendation-System/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/JAY TALERA/SEMESTER-7/Book-Recommendation-System/Book-Recommendation-System/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/JAY TALERA/SEMESTER-7/Book-Recommendation-System/Book-Recommendation-System/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/JAY TALERA/SEMESTER-7/Book-Recommendation-System/Book-Recommendation-System/venv\Library\lib tclstub86.lib'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='C:\ci\tk_1654036608655\work\tcl8.6.12\win\Release_AMD64_VC1916\tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='C:/JAY TALERA/SEMESTER-7/Book-Recommendation-System/Book-Recommendation-System/venv\Library\lib\tclstub86.lib'
